...
async function getStaticPaths() {
    ...
    const tagss = [
        ...new Set((0,_utils_methods__WEBPACK_IMPORTED_MODULE_9__.flatDeep)(posts.map(({ tags  })=>tags.map((tag)=>tag.slug))))
    ];
    return {
        paths: tagss.map((tag)=>({
                params: {
...
async function getStaticProps({ params  }) {
    const posts = (0,_lib_api__WEBPACK_IMPORTED_MODULE_10__/* .getPostsByTag */ .J4)(params.tag, [
        "title",
        "date",
        "slug",
        "image",
    ...
    const widgetPosts = (0,_lib_api__WEBPACK_IMPORTED_MODULE_10__/* .getAllPosts */ .Bd)([
        "title",
        "slug",
        "category",
        "tags"
...
var __webpack_exports__ = __webpack_require__.X(0, [3121,676,3061,2472,3715,9783,6180,3578,5173,938,7539,4369], () => (__webpack_exec__(6480)));
