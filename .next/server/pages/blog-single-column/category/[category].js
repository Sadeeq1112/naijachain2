...
const BlogSingleColumn = ({ posts , title , categories , recentPosts , tags  })=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_layout_wrapper__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
        children: [
...
async function getStaticProps({ params  }) {
    const posts = (0,_lib_api__WEBPACK_IMPORTED_MODULE_9__/* .getPostsByCategory */ .Td)(params.category, [
        "title",
        "date",
        "slug",
        "image",
    ...
    const widgetPosts = (0,_lib_api__WEBPACK_IMPORTED_MODULE_9__/* .getAllPosts */ .Bd)([
        "title",
        "slug",
        "category",
        "tags"
    ]);
    const categories = widgetPosts.map((blog)=>({
            ...blog.category
        }));
    const tags = widgetPosts.map((blog)=>[
            ...blog.tags
        ]);
...
var __webpack_exports__ = __webpack_require__.X(0, [3121,676,3061,2472,3715,9783,6180,3578,5173,938,7539,4369], () => (__webpack_exec__(4402)));
