...
const Home02 = ()=>{
    const liveAuctionData = _data_products_02_json__WEBPACK_IMPORTED_MODULE_7__.filter((prod)=>prod?.auction_date && new Date() <= new Date(prod?.auction_date)).slice(0, 5);
...
var __webpack_exports__ = __webpack_require__.X(0, [3121,676,3061,5152,2472,3715,9783,6180,3578,6188,2102,6078,7058], () => (__webpack_exec__(2657)));
