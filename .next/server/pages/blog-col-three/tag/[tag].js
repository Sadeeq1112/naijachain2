...
/* harmony import */ var _containers_blog_layout_05__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5887);
...
/* harmony import */ var _lib_api__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(1145);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_lib_api__WEBPACK_IMPORTED_MODULE_9__]);
_lib_api__WEBPACK_IMPORTED_MODULE_9__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
const BlogTwoColumn = ({ posts , title  })=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_layout_wrapper__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
        children: [
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_containers_blog_layout_05__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, {
                        data: {
                            posts
                        },
...
async function getStaticPaths() {
    const posts = (0,_lib_api__WEBPACK_IMPORTED_MODULE_9__/* .getAllPosts */ .Bd)([
        "tags"
    ]);
    const tagss = [
        ...new Set((0,_utils_methods__WEBPACK_IMPORTED_MODULE_8__.flatDeep)(posts.map(({ tags  })=>tags.map((tag)=>tag.slug))))
    ];
    return {
        paths: tagss.map((tag)=>({
                params: {
...
async function getStaticProps({ params  }) {
    const posts = (0,_lib_api__WEBPACK_IMPORTED_MODULE_9__/* .getPostsByTag */ .J4)(params.tag, [
        "title",
        "date",
        "slug",
        "image",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BlogTwoColumn);
...
var __webpack_exports__ = __webpack_require__.X(0, [3121,676,3061,2472,3715,9783,6180,3578,5173,8934,5887], () => (__webpack_exec__(9757)));
